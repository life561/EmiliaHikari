    ...
    if update.effective_chat.type == "private":
        ...
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup(
                ...
                [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/AnimeChatOfficial"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/AnimeChatOfficial")],
                [InlineKeyboardButton(text="❓ Help", url="https://t.me/{}?start=help".format(context.bot.username)), InlineKeyboardButton(text="💖 Donate", url="https://t.me/AnimeChatOfficial")]])
